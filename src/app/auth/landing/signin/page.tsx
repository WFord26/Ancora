    ...
    <AppSurface>
      <div className="flex min-h-screen items-center justify-center px-4 py-12">
        ...
        {process.env.NODE_ENV !== "production" && (
          <div className="rounded-lg border border-slate-800/80 bg-slate-900/50 p-4 text-sm text-slate-400 backdrop-blur">
            <p className="mb-2 font-medium text-slate-200">Demo Credentials:</p>
